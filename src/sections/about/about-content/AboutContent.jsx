...
const AboutContent = () => {
  return (
    <section className='py-5 text-center about-content'>
      <p>
        Eatit helps people to save TIME which is more Valuable than Money. It is
        because once you lose time, you will never get it back, not even a
        second of it.
      </p>
      <p>
      ...
      <p>
        After reaching the restaurant you only need to provide your order ID and
        your food will be in your table within 5-10 minutes.
      </p>
      <p>
